...
To install NextStudio, follow these steps:
    ...
    Clone the NextStudio repository from the official GitHub page, including submodules:

    shell

git clone --recurse-submodules https://github.com/yourusername/NextStudio.git
...
Build NextStudio using your preferred build system (e.g., Make or Ninja):
...
shell
    ...
    Once the build process is complete, you can find the NextStudio executable in the build directory.
