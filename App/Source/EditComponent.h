...
#include "MasterTrackComponent.h"
#include "MenuBar.h"
...
{
  public:
    EditComponent(te::Edit &, EditViewState &m_editViewState, ApplicationViewState &avs, te::SelectionManager &,
  ...
  private:
    ...
    MasterTrackComponent m_masterTrackComp{m_editViewState, m_edit, m_timeLine.getTimeLineID()};
    FooterBarComponent m_footerbar;

    MenuBar m_toolBar;
    juce::DrawableButton m_selectButton, m_lassoSelectButton, m_timeRangeSelectButton, m_splitClipButton,
        m_timeStretchButton, m_reverseClipButton, m_deleteClipButton;
