...
{
public:
    Thumbnail(int originalSamplesPerThumbnailSample, juce::AudioFormatManager &formatManager, juce::AudioThumbnailCache &cacheToUse);
    ...
    void addBlock(juce::int64 startSample, const juce::AudioBuffer<float> &incoming, int startOffsetInBuffer, int numSamples) override;
    ...
    void drawChannel(juce::Graphics &, juce::Rectangle<int> area, bool useHighRes, tracktion::TimeRange time, int channelNum, float verticalZoomFactor);

    void drawChannels(juce::Graphics &, juce::Rectangle<int> area, bool useHighRes, tracktion::TimeRange time, float verticalZoomFactor);
...
private:
    ...
    void drawChannel(juce::Graphics &, const juce::Rectangle<int> &area, double startTime, double endTime, int channelNum, float verticalZoomFactor) override;
    void drawChannels(juce::Graphics &, const juce::Rectangle<int> &area, double startTimeSeconds, double endTimeSeconds, float verticalZoomFactor) override;
