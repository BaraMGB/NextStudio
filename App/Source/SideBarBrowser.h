...
public:
    ...
    , m_playPauseBtn ("Play/Pause", juce::DrawableButton::ButtonStyle::ImageOnButtonBackgroundOriginalSize)
    , m_stopBtn ("Stop", juce::DrawableButton::ButtonStyle::ImageOnButtonBackgroundOriginalSize)
    , m_syncTempoBtn ("Sync Tempo", juce::DrawableButton::ButtonStyle::ImageOnButtonBackgroundOriginalSize)
    {
        ...
        Helpers::addAndMakeVisible(*this, {&m_playPauseBtn, &m_stopBtn, &m_syncTempoBtn});

        m_stopBtn.setTooltip(GUIHelpers::translate("Stop playing", m_avs));
        m_playPauseBtn.setTooltip(GUIHelpers::translate("Play sample", m_avs));
    ...
    void paint(juce::Graphics &g) override
    {
        ...
        auto x = m_volumeSlider->getWidth() + m_playPauseBtn.getWidth() + 6;
        g.drawVerticalLine(x, 0, getHeight());
        auto rect = getLocalBounds();
        rect.removeFromLeft(m_volumeSlider->getWidth());
    }
    ...
    void resized() override
    {
        ...
        auto buttonArea = area.removeFromLeft(20);
        auto buttonRect = buttonArea.getHeight()/3;
        m_playPauseBtn.setBounds(buttonArea.removeFromTop(buttonRect));//.reduced(1,1));
        m_stopBtn.setBounds(buttonArea.removeFromTop(buttonRect));//.reduced(1,1));
        m_syncTempoBtn.setBounds(buttonArea.removeFromTop(buttonRect));//.reduced(1,1));
        ...
        if (m_previewEdit)
        {
            ...
            m_playPauseBtn.setColour(juce::TextButton::buttonColourId, playBtnColour);
...
private:
    ...
    juce::DrawableButton m_playPauseBtn, m_stopBtn, m_syncTempoBtn;
